...
\addtofrontsidebar{
    ...
    \vspace{-0.5em}
	    %
        \longskill{\faPython}
          {\textbf{9+ years of Python development}, applied to scientific computing and industrial solutions.}
        %
        \vspace{0.5em}
        %
        \longskill{\faBrain}
          {\textbf{6+ years of hands-on ML experience}, designing and deploying predictive models.}
        %
        \vspace{0.5em}
        %
        \longskill{\faAtom}
...
\addtobacksidebar{
    ...
    \vspace{-0.5em}
        ...
        \skill{\faLaptopCode}{\textbf{Data Science Toolkit}}
            ...
            %
            \skill[1.5em]{\faAngleRight}{
                \underline{Model optimization:}\\ \texttt{optuna}, \texttt{pyomo}, \texttt{gurobipy}
            }
        %
        \vspace{0.5em}
        %
...
%    }\\ [-1em]
    %
%    \cvcertitem{Azure AI Engineer Associate (AI-103)}
...
%    }\\ [-1em]
    %
%    \cvcertitem{Azure AI Fundamentals (AI-901)}
%      {Microsoft}{\faClipboardCheck \, Certification}{2026}
    %
%    \vspace{-1em}
%    \raisebox{0.8em}{%
...
%    }\\ [-1em]
    %
    \cvcertitem{Reinvention with Agentic AI}
      {Accenture}{\faAward \, Badge}{2026}
    %
    \vspace{-1em}
    \raisebox{0.8em}{%
        \hdashrule{\linewidth}{0.1pt}{2pt 2pt}%
    ...
    %
    \cvcertitem{Integrating Quantum and High-Performance Computing}
    ...
    %
    \cvcertitem{AWS Knowledge: Amazon Braket - Training Badge}
      {Amazon Web Services}{\faAward \, Badge}{2026}
    %
%    \vspace{-1em}
%    \raisebox{0.8em}{%
%        \hdashrule{\linewidth}{0.1pt}{2pt 2pt}%
