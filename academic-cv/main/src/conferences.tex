...
\begin{cvcontent}
  ...
  %%%  SOSC 2022
  %%% ===========
%   \event{4th International School on Open Science Cloud}{Perugia, Italy}\\
%   \organizer{INFN Perugia}{Nov 2022}\\
%   \theme{Computing Models for Scientific Experiments} (participant) \hfill
%   \button{https://agenda.infn.it/event/31408/}{\faGlobe}
%   \\ [4mm]
  %%%
  %%%  ML_INFN hackathon
  %%% ===================
%   \event{3rd ML\_INFN Hackathon: Advanced Level}{Bari, Italy}\\
%   \organizer{ML\_INFN \& INFN Bari}{Nov 2022}\\
%   \contribution{Oral}{Generative Models and Normalizing Flows} \hfill
%   \button{https://agenda.infn.it/event/32568/contributions/180759/}{\faGlobe}\\
%   \contribution{Oral}{Bayesian optimization and hyperparameter tuning} \hfill
%   \button{https://agenda.infn.it/event/32568/contributions/180769/}{\faGlobe}
%   \\ [4mm]
  %%%
  %%%  ACAT 2022
  %%% ===========
  ...
  \\
  \contribution{Poster}{Hyperparameter Optimization as a Service on INFN Cloud} \hfill
  ...
  \button{https://mbarbetti.github.io/poster-acat2022-hopaas/poster.html}{\faLink}
...
%   \\ [4mm]
  ...
  \theme{Scientific Software for Heterogeneous Architectures} (participant) \hfill
