...
\begin{cvcontent}
  ...
  \begin{itemize*}[label=\textcolor{iconcolor}{\textbullet}]
    %
    \item \teachclass{B015862: Physics Laboratory III}{Head TA for Vitaliano Ciulli}{2022}\\ [0.5mm]
    %
  ...
  \begin{itemize*}[label=\textcolor{iconcolor}{\textbullet}]
    %
    \item \teachclass{B016237: Physics II}{Lab Tutor and TA for Piergiulio Lenzi}{2021}
    %
  \end{itemize*}
  \\ [3mm]
  %%%
